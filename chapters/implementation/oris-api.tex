...
Z přijatých dat je pomocí speciální třídy (mapperu) sestaven nový objekt typu \mintinline{text}|Race|, jenž je následně předán formuláři. Ten si již jen načte data z tohoto objektu a výsledná stránka s předvyplněnými hodnotami je zaslána uživateli.
