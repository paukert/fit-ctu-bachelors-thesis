...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ctufittitle{Systém pro~kluby orientačního běhu} % replace with the title of your thesis
...
\input{text/appendix} % include `appendix.tex' from `text/' subdirectory

\backmatter % do not remove this command

\printbibliography % print out the BibLaTeX-generated bibliography list

\input{text/medium} % include `medium.tex' from `text/' subdirectory
