...
\ctufitkeywordsCZE{monolitická webová aplikace, informační systém, sportovní klub, přihlašování na události, ORIS API, PHP}
\ctufitkeywordsENG{monolithic web application, information system, sports club, register for events, ORIS API, PHP}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END FILL IN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ORM & Objektově relační mapování\\
    & (z anglického Object–relational mapping)\\
